...
bool SRTF_comparator(process &p1, process &p2)
{
...
void SRTF_scheduling(vector<process> &P)
{
    int n = P.size();
    priority_queue<process, vector<process>, SRTF_comp>pq;
...
int main()
{
    ...
    sort(P.begin(), P.end(), SRTF_comparator);
